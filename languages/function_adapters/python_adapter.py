...
class PythonAdapter:
    ...
    def create_python_function_signature(self, function_name, function):
        ...
        return FunctionSignature(name=function_name, language='python', implementation=function, return_type=return_type, parameters=params)
    ...
    def get_function_metadata(self, function_name):
        ...
        function = self.functions[function_name]
        sig = inspect.signature(function)
        return {'name': function_name, 'language': 'python', 'signature': str(sig), 'doc': function.__doc__ or 'No documentation', 'module': function.__module__}
